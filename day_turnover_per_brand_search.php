...
$query = "SELECT b.name, g.date, SUM(g.turnover- round(((g.turnover /100)*21),2)) as turnover FROM brands b INNER JOIN gmv g ON g.brand_id = b.id WHERE 1 $brand $date_range GROUP BY g.date, b.id";
