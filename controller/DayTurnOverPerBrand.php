...
class DayTurnOverPerBrand extends Reports {

    public $title;

    function __construct() {
        $this->title = 'DAYS TURNOVER PER BRAND';
    }
    ...
    public function search($request, $connection) {
        ...
        $query = "SELECT b.name, g.date, SUM(g.turnover) as turnover FROM brands b INNER JOIN gmv g ON g.brand_id = b.id WHERE 1 $brand $date_range GROUP BY g.date, b.id";
